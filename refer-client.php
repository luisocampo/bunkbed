...
<div class="container">
  ...
  <h1>Client Details</h1>
    <h4>Please double check this individual's details before referring them.</h4>
...
<div class="container">
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" name="frm_last_name" value="Hanks">
  </div>	
 <div class="form-group">
    <label>First Name</label>
    <input type="text" class="form-control" name="frm_first_name" value="Robert">
  </div>	

  <div class="form-group">
    <label>Date of Birth</label>
    <input type="text" class="form-control" name="frm_last_name" value="1/1/1953">
  </div>	
 ...
 <div class="form-group">
    ...
    <input type="text" class="form-control" name="frmUserName" value="hanks.robert@gmail.com">
  </div>
...
<hr>
 ...
 <div class="form-group">
    ...
    <tbody>
     ...
     <label>Is this person safe to admit to a shelter?</label>
   <div class="radio">
  <label><input type="radio" name="optradio">Yes</label>
</div>
     <div class="radio">
  <label><input type="radio" name="optradio">No (explain why:)</label>
</div>
     <div class="form-group">
	  <input type="text" class="form-control" name="frmUserName" value="" style="width:200px;" >
	</div>
...
<a class="btn btn-warning" href="select-shelter.php" >Refer Client</a>
